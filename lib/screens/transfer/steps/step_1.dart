...
import 'package:nabe_bank_application/core/services/bank_service.dart';
...
class TransferController extends GetxController {
  ...
  final RxList<BankModel> bankData = <BankModel>[].obs;
  ...
  Future<void> fetchData() async {
    try {
      final data = await bankService.fetchAllBank();
